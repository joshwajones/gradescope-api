...
class GSAccount:
    ...
    def delete_classes(
        ...
        *,
        ...
        courses_to_delete = self._find_classes_regex(
            course_ids=course_ids, course_names=course_names, instructor=True
        )
    ...
    def get_classes(
        ...
        *,
        ...
        return self._find_classes_regex(
            course_ids=course_ids, course_names=course_names, instructor=instructor
        )
    ...
    def create_course(
        ...
        course_id = re.match(
            ...
            .find("div", class_="courseHeader--courseID")
            .text,
        )
